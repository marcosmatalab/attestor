...
is always a NEW bundle file, never a migration of an existing one: the ledger
anchors bundle hashes, and rewriting an artifact whose hash is already anchored is
precisely what an evidence system must not do.
